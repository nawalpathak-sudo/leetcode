...
import { loadAllProfiles, invalidateProfileCache } from '@/lib/homepage-db'
      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5" style={{ background: 'rgba(5, 10, 24, 0.8)', backdropFilter: 'blur(20px)' }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/practice" className="text-white/50 hover:text-white text-sm font-medium transition-colors hidden sm:block">Practice</Link>
            <Link href="/projects" className="text-white/50 hover:text-white text-sm font-medium transition-colors hidden sm:block">Projects</Link>
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-white/20 text-sm">
            <Link href="/practice" className="hover:text-[#F59E0B] transition-colors">Practice</Link>
            <Link href="/projects" className="hover:text-[#F59E0B] transition-colors">Projects</Link>
            <Link href="/portal" className="hover:text-[#F59E0B] transition-colors">Student Portal</Link>
