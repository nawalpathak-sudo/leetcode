...
import {
  FolderGit2, ExternalLink, Globe, Plus, X, Search, Trash2, Users,
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {project.github_url && <FolderGit2 size={14} className="text-primary/30" />}
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-semibold text-primary mb-1">
            <FolderGit2 size={14} className="inline mr-1" /> GitHub Repo URL
          </label>
          <input
